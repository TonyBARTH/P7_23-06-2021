...
const User = dbConnexion.define('user', {
  ...
  /* Data schema */
  username: { type: Sequelize.STRING, allowNull:false, unique: true }, /* Must be unique */
  ...
  admin: { type: Sequelize.BOOLEAN, allowNull: false, defaultValue: false } /* For access control */
});
